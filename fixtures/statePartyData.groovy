 ...
 * Date: 3/26/14
 * Time: 10:53 AM
 * To change this file use generateCountries.groovy
 */
...
fixture {
    ...
    sp149(StateParty) {
        country =  "THE_FORMER_YUGOSLAV_REPUBLIC_OF_MACEDONIA"
    ...
    sp164(StateParty) {
        country =  "VENEZUELA_BOLIVARIAN_REPUBLIC_OF"
    ...
    /*Initial users to be created for demo are Sweden, US, UK, Malaysia, Belgium and Switzerland*/
/*    user1(User) {
        username = "afg"
        password = "AFG123"
        stateParty = [sp1]
