	...
	<body>
		...
		<div id="show-nationalContact" class="content scaffold-show" role="main">
			...
			<ol class="property-list nationalContact">
				...
				<li class="fieldcontain">
					<span id="organization-label" class="property-label"><g:message code="nationalContact.organization.label" default="Organization" /></span>
				...
				<li class="fieldcontain">
					<span id="address-label" class="property-label"><g:message code="nationalContact.address.label" default="Address" /></span>
						...
						<span class="property-value" aria-labelledby="address-label"><g:fieldValue bean="${nationalContactInstance}" field="location"/>, <g:fieldValue bean="${nationalContactInstance}" field="country"/></span>
			...
			<g:form url="[resource:nationalContactInstance, action:'delete']" method="DELETE">
				...
				<fieldset class="buttons">
                    ...
                    <g:link class="print" action="print" resource="${nationalContactInstance}" target="_blank"
