...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><g:select name="formAPart1.yearOfLastDeclaration" from="${formZeroInstance.formAPart1?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formAPart1?.yearOfLastDeclaration}" /></td> <!--noSelection="[null:'-Select year-']"-->
        </tr>
        <tr>
            ...
            <td><g:select name="formAPart2a.yearOfLastDeclaration" from="${formZeroInstance?.formAPart2a?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formAPart2a?.yearOfLastDeclaration}"/></td>
        </tr>
        <tr>
            ...
            <td><g:select name="formAPart2b.yearOfLastDeclaration" from="${formZeroInstance?.formAPart2b?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formAPart2b?.yearOfLastDeclaration}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td><g:select name="formAPart2c.yearOfLastDeclaration" from="${formZeroInstance?.formAPart2c?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formAPart2c?.yearOfLastDeclaration}"/></td>
        </tr>
        <tr>
            ...
            <td><g:select name="formB.yearOfLastDeclaration" from="${formZeroInstance.formB?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formB?.yearOfLastDeclaration}"/></td>
        </tr>
        <tr>
            ...
            <td><g:select name="formC.yearOfLastDeclaration" from="${formZeroInstance.formC?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formC?.yearOfLastDeclaration}"/></td>
        </tr>
        <tr>
            ...
            <td><g:select name="formE.yearOfLastDeclaration" from="${formZeroInstance.formE?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formE?.yearOfLastDeclaration}"/></td>
        </tr>
        <tr>
            ...
            <td><g:select name="formF.yearOfLastDeclaration" from="${formZeroInstance.formF?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formF?.yearOfLastDeclaration}"/></td>
        </tr>
        <tr>
            ...
            <td><g:select name="formG.yearOfLastDeclaration" from="${formZeroInstance.formG?.constraints.yearOfLastDeclaration?.range}" class="range" required="" value="${formZeroInstance.formG?.yearOfLastDeclaration}"/></td>
        </tr>
