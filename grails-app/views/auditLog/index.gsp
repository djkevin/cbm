...
<div id="list-auditLog" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="actor" title="${message(code: 'auditLog.actor.label', default: 'User')}"/>

            <g:sortableColumn property="className" title="${message(code: 'auditLog.className.label', default: 'Page')}"/>

            <g:sortableColumn property="eventName" title="${message(code: 'auditLog.eventName.label', default: 'Action')}"/>
            ...
            <g:sortableColumn property="persistedObjectId" title="${message(code: 'auditLog.persistedObjectId.label', default: ' Object Id')}"/>
