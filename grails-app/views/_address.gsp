<div class="fieldcontain ${hasErrors(bean: addressInstance.location, field: 'street1', 'error')} ">
    ...
    <g:textField name="location.street1" maxlength="200" value="${addressInstance?.location?.street1}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: addressInstance.location, field: 'street2', 'error')} ">
    ...
    <g:textField name="location.street2" maxlength="200" value="${addressInstance?.location?.street2}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: addressInstance.location, field: 'country', 'error')} required">
    ...
    <g:select name="location.country" from="${cbm.Country?.values()}" keys="${cbm.Country.values()*.name()}" required="" value="${addressInstance?.location?.country?.name()}"/>
</div>